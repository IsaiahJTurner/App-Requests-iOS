...
/* connect to the db */
$connection = mysql_connect('mysql14.000webhost.com','a5900984_admin','3HLMuVHG8BVG5BsyRQmg2ztKrmBLRWZgxyyMZnAXqwEga2X7Wr');
mysql_select_db('a5900984_ideas',$connection);
